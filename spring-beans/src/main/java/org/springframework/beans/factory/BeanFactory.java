...
public interface BeanFactory {
	 ...
	 */
	//对FactoryBean的转义定义，因为如果使用bean的名字检索FactoryBean，得到的
	//对象是工厂生成的对象，如果需要得到工厂本身，需要对其进行转义
	 ...
	 */
	//提供对bean的检索，检查在IOC容器中是否有该name的bean
